...
public class URLCodec // implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder
{
  ...
  * @throws DecodingException Thrown if URL decoding is unsuccessful
  */
     ...
     for (int i = 0; i < bytes.length; i++) {
         ...
         if (b == '+') {
             ...
             try {
                 ...
                 if (u == -1 || l == -1) {
                     throw new DecodingException("Invalid URL encoding");
                 }
  ...
  * @throws DecodingException Thrown if URL decoding is unsuccessful
  */
 public byte[] decode(byte[] bytes) throws DecodingException {
  ...
  * @param pString string to convert to a URL safe form
  * @return URL safe string
  * @throws EncodingException Thrown if URL encoding is unsuccessful
  * 
  * @see #getDefaultCharset()
  */
 public String encode(String pString) throws EncodingException {
     if (pString == null) {
         return null;
     }
     try {
 ...
 public String decode(String pString, String charset) 
     throws DecodingException, UnsupportedEncodingException 
 {
     if (pString == null) {
         return null;
     }
  ...
  * @see #getDefaultCharset()
  */
 public String decode(String pString) throws DecodingException {
     if (pString == null) {
         return null;
     }
     try {
  ...
  * @throws EncodingException Thrown if URL encoding is not 
  *                          applicable to objects of this type or
  *                          if encoding is unsuccessful
  */
 public Object encode(Object pObject) throws EncodingException {
     if (pObject == null) {
         return null;
         ...
         throw new EncodingException("Objects of type " +
  ...
  */
 public Object decode(Object pObject) throws DecodingException {
     if (pObject == null) {
         return null;
     } else if (pObject instanceof byte[]) {
         ...
         throw new DecodingException("Objects of type " + pObject.getClass().getName() + " cannot be URL decoded");
