...
public class URN {
  ...
  /**
   * Lazy initialized value for the hash code of a URN. If the URN is modified this value must be
  ...
  /**
   * Parses a string into a URN. If the URN string is not valid a IllegalArgumentException is
   * thrown.
   */
  ...
  /**
   * Override equals() to ensure that two different instances with equal URN are "equal".
   */
  ...
  /**
   * Override hashCode() to ensure that two different instances with equal URN generate the same
   * hashCode. This is necessary to find URNs in Maps.
   */
  public int hashCode() {
  ...
  /**
   * Retruns true if the given string is a valid URN. According to RFC 2141: All URNs have the
   * following syntax (phrases enclosed in quotes are REQUIRED):<br>
   * <URN> ::= "urn:" <NID> ":" <NSS>
   */
  ...
  /**
   * Checks if this namespace specific string is valid. Valid is the nss part of
   * urn:bitprint:[32-character-SHA1].[39-character-TigerTree] and urn:sha1:[32-character-SHA1]
   */
  ...
  /**
   * Checks if this namespace identifier is supported. Only sha1 is supported currently.
   */
